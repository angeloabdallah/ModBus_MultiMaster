...
const bool startAsMaster         = true;        // True for a Master Node, False for a Slave Node
const char thisNodeAddress       = 0x03;        // Slave Address
const char nextMasterAddress     = 0x01;        // When passing the token to another node
