...
const unsigned char modbusMultiMaster::_auchCRCHi[] = { 
...
const unsigned char modbusMultiMaster::_auchCRCLo[] = { 
...
bool modbusMultiMaster::_safe2Write = true;  // Flag for bus not busy (wait for >= 3.5 chars after a frame)
